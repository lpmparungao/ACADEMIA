...
class NotesSearch extends SearchDelegate<Note> {
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                ...
                subtitle: Text(
                  filteredNotes[index].descriptionNote,
  ...
  List<Note> getFilteredList(List<Note> note) {
    for (int i = 0; i < note.length; i++) {
      if (note[i].titleNote.toLowerCase().contains(query) ||
          note[i].descriptionNote.toLowerCase().contains(query)) {
