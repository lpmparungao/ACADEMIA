...
//   Future<List<ScheduleModel>> _schedList;
...
//     User myUser = AddSchedule.theUser;
...
// Widget _buildSched (ScheduleModel schedule){
//     return Padding(
...
//                 color: Colors.black,
//                 fontSize: 18,
//                 decoration: schedule.statusSched == 0 
//                 ? TextDecoration.none
//                 : TextDecoration.lineThrough,
//               ),
//             ),
//             subtitle: Text('${schedule.dateSchedStart} ● ${schedule.prioritySched}\n${schedule.repeatSched}',
//               style: TextStyle(
//                   color: Colors.grey,
//                   fontSize: 15,
//                   decoration: schedule.statusSched == 0 
...
//               value: schedule.statusSched == 1 ? true : false,
//             ),
//             onTap: (){}
//           ),
//           Divider(),
...
//     for (Task task in AddSchedule.theUser.tasks) {
//       for (Occurrence occurs in task.occurrence) {
...
//     List<Task> taskList = AddSchedule.theUser.tasks;
//     for (Task task in taskList) {
//       if (task.name == taskName) {
//         task.removeOccurrenceByDay(day);
//       }
//     }
//     AddSchedule.theUser.tasks = taskList;
//   }
